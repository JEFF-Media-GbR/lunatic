...
public final class ServerUtils {
    ...
    static {
        CURRENT_TICK_FIELD = ReflectionUtils.getField(Bukkit.getScheduler().getClass(), "currentTick");
        ...
        HAS_TRANSLATION_KEY_PROVIDER = ReflectionUtils.getMethod(Material.class, "getBlockTranslationKey") != null;
    }
    ...
    public static CompletableFuture<String> getEffectiveMotd() {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ServerListPingEvent event = ServerListPingEventFactory.createServerListPingEvent(LOCALHOST.getHostName(),
                    LOCALHOST,
                    Bukkit.getMotd(),
                    false,
    ...
    public static boolean isRunningMockBukkit() {
        return ReflectionUtils.classExists("be.seeseemelk.mockbukkit.ServerMock");
    }
    ...
    public static boolean isRunningForge() {
        return ReflectionUtils.classExists("net.minecraftforge.server.ServerMain");
    }
    ...
    public static boolean isRunningSpigot() {
        return ReflectionUtils.classExists("net.md_5.bungee.api.ChatColor");
    }
    ...
    public static boolean isRunningPaper() {
        return ReflectionUtils.classExists("com.destroystokyo.paper.PaperConfig");
    }
